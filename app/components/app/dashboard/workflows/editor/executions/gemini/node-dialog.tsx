...
export const AVAILABLE_MODELS = ["gemini-2.5-flash", "gemini-2.5-flash-lite", "gemini-2.5-pro"] as const
...
interface GeminiNodeDialogProps {
	...
	onSubmit: (values: GeminiFormData) => void
	nodeData: GeminiNodeData
}

export function GeminiNodeDialog({ open, onOpenChange, onSubmit, nodeData }: GeminiNodeDialogProps) {
