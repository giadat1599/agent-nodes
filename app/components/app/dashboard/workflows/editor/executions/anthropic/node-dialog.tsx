...
import type { AnthropicNodeData } from "./node"

export const AVAILABLE_MODELS = ["claude-sonnet-4-0", "claude-sonnet-4-5"] as const
...
interface AnthropicNodeDialogProps {
	...
	onSubmit: (values: AnthropicFormData) => void
	nodeData: AnthropicNodeData
}

export function AnthropicNodeDialog({ open, onOpenChange, onSubmit, nodeData }: AnthropicNodeDialogProps) {
